    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Hobbies</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--  <li class="dropdown">
                        <a href="#portfolio" class="dropdown-toggle" data-toggle="dropdown">Sesiones <b class="caret"></b></a>
                    ...
                    <li>
                     ...
                     <li>
                        <a class="page-scroll" href="#portfolio">Sesiones</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Bienvenido a tu Tiempo Libre!</div>
                <div class="intro-heading">Tus Hobbies</div>
                <a href="#portfolio" class="page-scroll btn btn-xl">Leer M�s</a>
            </div>
        </div>
    </header>
