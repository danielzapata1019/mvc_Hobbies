    ...
    <section id="services">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                   <img class="img-circle" height="200" width="200" src="../resources/img/portfolio/tipos.jpg">
                    <h4 class="service-heading"></h4>
                    <p class="text-muted" align="justify">El objetivo de Caminar es aportar al mejoramiento de la calidad de vida de los participantes, las buenas relaciones y el compromiso con el medio ambiente.
                    										Caminar Favorece la práctica de hábitos saludables, ayuda a Beneficiar los estados de salud, la lúdica y la convivencia.</p>
                </div>
                <div class="col-md-4">
                   <img class="img-circle" height="200" width="200" src="../resources/img/portfolio/caminante.jpg">
                    <h4 class="service-heading"></h4>
                    <p class="text-muted" align="justify">También busca Satisfacer una necesidad vital e instintiva del ser humano, en la que podemos conjugar elementos de ejercicio físico moderado, recreación, socialización, culturización y sensibilización tanto individual como grupal.</p>
                </div>
                <div class="col-md-4">
                    <img class="img-circle" height="200" width="200" src="../resources/img/portfolio/sendero.jpg">
                    <h4 class="service-heading"></h4>
                    <p class="text-muted" align="justify">Otro Objetivo de Caminar es Aportar a la formación personal en el respeto por las diferentes formas de vida ambiental y humana, sentido de pertenencia por el hábitat o entorno, territorialidad, diversificación del ejercicio físico moderado, la motricidad, la recreación contemplativa y sensible, y la lúdica naturalista.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
				...
				<table>
				  <tr>
					...
					<td></td>
				    <td><img class="img-circle" src="../resources/img/about/urbana2.jpg" alt=""></td>
				    <td>    </td>
				    <td>   </td>
				    <td>
                    <ul>
                        <li>                    
                         <h4 class="subheading">Caminadas Urbanas</h4>
                         <p class="text-muted" align="justify">Son caminadas realizadas en áreas pobladas y habitadas de forma permanente, lugares donde predominan las construcciones, parques, cabeceras municipales o áreas centrales de los corregimientos; también unidades deportivas, cerros tutelares, calles, plazas, áreas peatonales, parques bibliotecas y lugares inmersos dentro de la urbe metropolitana, que son de gran interés por el contenido cultural, arquitectónico, histórico y de reconocimiento de ciudad, son caminadas cortas, de fácil acceso. </p>
    					 </li></ul>
                     </td> 
				  ...
				  <tr>
				  <td></td>
				    <td><img class="img-circle"  height="200" width="200" src="../resources/img/about/camina8.jpg" alt=""></td>
				    <td>    </td>
				    <td>   </td>
				    <td>
                    <ul>
                        <li>                    
                          <h4 class="subheading">Caminadas Rurales</h4>
                          <p class="text-muted">Se caracterizan por sus verdes recorridos, incluyen zonas boscosas, cuencas hidrográficas, cerros tutelares, áreas con poca población y pocas construcciones, por ende, poco habitadas; predominan también las zonas agropecuarias y parques ecológicos de los diferentes corregimientos y municipios alrededor de Medellín, son caminadas con alto contenido ecológico, cultural e histórico, predominan los caminos y senderos, con alto contenido de flora y fauna. </p>
    					 </li></ul>
                     </td> 
				  ...
				  <tr>
				  <td></td>
				    <td><img class="img-circle"  height="200" width="200" src="../resources/img/about/camina5.jpg" alt=""></td>
				    <td>    </td>
				    <td>   </td>
				    <td>
                    <ul>
                        <li>                    
                          <h4 class="subheading">Caminadas Limitrofes</h4>
                          <p class="text-muted">Hacen relación a las caminadas realizadas, (que inician, finalizan o recorren territorios) en los municipios que tienen límites con Medellín, el Área Metropolitana del Valle de Aburrá, Valle de San Nicolás, oriente cercano, también occidente y norte cercano de Antioquia. </p>
    					 </li></ul>
                     </td> 
