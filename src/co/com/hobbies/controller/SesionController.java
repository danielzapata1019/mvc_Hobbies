...
import co.com.hobbies.portada.Sesion;
...
public class SesionController {// crea el objeto tipo modelAndView
	...
	public ModelAndView inicioSesiones(){
		...
		ModelAndView modelAndView = new ModelAndView("index","sesionobj", new Sesion());//el New sesion es el nombre de la clase donde tenemos la portada
		return modelAndView; 
	}
